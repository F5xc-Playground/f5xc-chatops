...
module.exports = {
  ...
  intents: [
    ...
    { utterance: 'site connectivity overview', intent: 'site.status' },
    { utterance: 'list customer edge sites', intent: 'site.status' },
    { utterance: 'show CE sites', intent: 'site.status' },
    { utterance: 'list regional edge sites', intent: 'site.status' },
    ...
    { utterance: 'list all CE and RE sites', intent: 'site.status' },

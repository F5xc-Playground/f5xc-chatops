module.exports = {
  ...
  intents: [
    ...
    { utterance: 'is the protection in blocking mode', intent: 'waf.status' },
    { utterance: 'WAF configuration', intent: 'waf.status' },
    { utterance: 'check the web application protection', intent: 'waf.status' },
    ...
    { utterance: 'what is the web application protection mode', intent: 'waf.status' },
  ],
